...
import { getFirestore, collection, addDoc, doc, setDoc, getDocs, query, where, orderBy, limit } from 'firebase/firestore';
...
export { signUpWithEmailAndPassword, signInWithEmailAndPassword, db, collection, addDoc, setDoc, doc, getDocs, query, where, orderBy, limit }; // Export db reference
